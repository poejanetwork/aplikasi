...
> © CMS - By <span class="fw-bold text-decoration-underline text-uppercase text-reset fs-12">Abu_puja</span>
                        </div>
                        <div class="col-md-6">
    ...
    <div class="modal fade" id="dataModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="dataModalTitle" aria-hidden="true">
...
/assets/js/vendor.min.js"><?php echo '</script'; ?>
>
    <!-- App js -->
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->getValue('theme');?>
