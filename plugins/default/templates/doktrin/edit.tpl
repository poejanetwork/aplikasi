        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="formEditData" data-id="{$data.id}" enctype="multipart/form-data">
                    <input type="hidden" name="storage_type" id="storage_type" value="{$data.storage_type}">
                    <input type="hidden" name="file_name" id="file_name" value="{$data.file_name}">
                    <input type="hidden" name="file_size" id="file_size" value="{$data.file_size}">
                    <input type="hidden" name="file_type" id="file_type" value="{$data.file_type}">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="doktrin_id" name="doktrin_id">
                            ...
                            <option value="{$item.id}" data-slug="{$item.slug}" {if $item.id == $data.doktrin_id}selected{/if}>{$item.name}</option>
                            {/foreach}
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="tahun" name="tahun" class="form-control" value="{$data.tahun}">
                    </div>

                    <div class="mb-3">
                        <label for="file_path" class="form-label">Link URL File</label>
                        <input type="text" id="file_path" name="file_path" class="form-control" placeholder="Masukkan link google drive atau gunakan uploader dibawah" value="{$data.file_path}">
                    </div>
