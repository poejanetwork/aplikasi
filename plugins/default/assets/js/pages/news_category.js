(function ($) {
    ...
    function loadData(page = 1) {
        currentPage = page;
        $.get(APP.getUrl + '/news_category/data', {
            page: page,
    ...
    window.addData = function (id) {
        ...
        $('#dataModalBody').load(
            APP.getUrl + '/news_category/create/'
        );
    };
    $(document).on('submit', '#formAddData', function (e) {
        ...
        let form = $(this);
        $.ajax({
            url: APP.getUrl + '/news_category/store',
            type: 'POST',
            data: form.serialize(),
            dataType: 'json',
    ...
    window.editData = function (id) {
        ...
        $('#dataModalBody').load(
            APP.getUrl + '/news_category/edit/' + id
        );
    };
    $(document).on('submit', '#formEditData', function (e) {
        ...
        $.ajax({
            url: APP.getUrl + '/news_category/update/' + id,
            type: 'POST',
