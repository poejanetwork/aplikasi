    ...
    <div class="row g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
        <div class="col-xl-12 col-lg-12 col-md-12">
            <div class="overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                <a href="{'/'|surl}" class="auth-brand mb-3">
                    <img src="{$theme}/assets/images/logo.png" alt="logo light" height="24" class="logo-light">
                </a>

                <div class="mx-auto text-center">
                    <img src="{$theme}/assets/images/error/error-404.png" alt="error 403 img" height="180" class="my-3">
                    ...
                    <a href="{'/'|surl}" class="btn btn-primary">Back to Home <i class="ti ti-home ms-1"></i></a>
                </div>
            </div>
        </div>
    </div>
