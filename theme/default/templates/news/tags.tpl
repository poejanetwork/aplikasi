     ...
     <div class="row mx-0">
		   ...
		   <div class="col-md-10 p-0">
		     <div class="contact_righto  p-3 bg-white">
			      <span class="mb-0 font_11 light_gray"><a class="fw-bold" href="{$settings.BASE_URL}">Home</a> <span class="mx-2">/</span> <a class="fw-bold" href="{'news'|surl}">Berita</a></span>
			 </div>
		   </div>
		 </div>
   </div>
                        ...
                        <div class="col">
                            <div class="card mb-3">
                                <div class="card-body p-0">
                                    ...
                                    Tidak ada hasil pada pencarian "{$query}"
                                    </div>
                                </div>
                            </div>
                        </div>
